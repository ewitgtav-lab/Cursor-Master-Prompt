...
def _gemini_vision_ocr(images: list["Image.Image"]) -> str:
    ...
    try:
        ...
        from PIL import Image  # noqa: F401  (runtime type)
    except Exception as e:
        raise RuntimeError("Gemini vision OCR requires google-generativeai and pillow.") from e
    ...
    # Send as a single request with multiple images when possible.
    resp = model.generate_content([prompt, *images], generation_config={"temperature": 0.0, "max_output_tokens": 4096})
